...
![](通达OA-v11.8-文件包含XSS漏洞.assets/1627363523208471.jpg)
...
![](通达OA-v11.8-文件包含XSS漏洞.assets/1627363523567795.jpg)

这里再上传 XSS文件 **peiqi.log** 被包含进去

![](通达OA-v11.8-文件包含XSS漏洞.assets/1627363524019804.jpg)

上传后每次管理员登录后都会带着Cookie请求一次XSS平台

![](通达OA-v11.8-文件包含XSS漏洞.assets/1627363524617397.jpg)

钓鱼什么的代码写在peiqi.log文件里就好啦

刚刚提到了 v11.7版本不方便利用，这是因为在后续版本加上了文件上传的规定路径

![](通达OA-v11.8-文件包含XSS漏洞.assets/1627363524934601.jpg)
...
![](通达OA-v11.8-文件包含XSS漏洞.assets/16273635251843698.jpg)

 这里XSS的利用点有4个文件夹，其中最有几率XSS的为**存储目录管理的文件夹**

![](通达OA-v11.8-文件包含XSS漏洞.assets/1627363525363439.jpg)
...
![](通达OA-v11.8-文件包含XSS漏洞.assets/1627363525691016.jpg)
