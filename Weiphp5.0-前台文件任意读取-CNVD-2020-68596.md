...
![](Weiphp5.0-前台文件任意读取-CNVD-2020-68596.assets/16273630294184508.jpg)
...
![](Weiphp5.0-前台文件任意读取-CNVD-2020-68596.assets/16273630297998269.jpg)
...
![](Weiphp5.0-前台文件任意读取-CNVD-2020-68596.assets/1627363030160089.jpg)
...
![](Weiphp5.0-前台文件任意读取-CNVD-2020-68596.assets/1627363030413087.jpg)
...
![](Weiphp5.0-前台文件任意读取-CNVD-2020-68596.assets/1627363030673814.jpg)

查看目录**/public/uploads/picture/**，并用记事本打开写入的jpg文件

![](Weiphp5.0-前台文件任意读取-CNVD-2020-68596.assets/1627363030969783.jpg)

得到数据库配置文件的信息，既然这个变量可控，我们也可以通过这个方法下载木马文件，再通过解析漏洞或者文件包含等其他漏洞来getshell

![](Weiphp5.0-前台文件任意读取-CNVD-2020-68596.assets/1627363031325474.jpg)

在当前条件下并不知道文件名是什么，所以回到代码中继续寻找可以获取文件名的办法

![](Weiphp5.0-前台文件任意读取-CNVD-2020-68596.assets/162736303159993.jpg)
...
![](Weiphp5.0-前台文件任意读取-CNVD-2020-68596.assets/16273630318607612.jpg)
...
![](Weiphp5.0-前台文件任意读取-CNVD-2020-68596.assets/162736303227207.jpg)

我们现在则需要找到不需要登录的地方来获得这些数据，所以可以全局去查找调用了这个 Picture 表的地方

![](Weiphp5.0-前台文件任意读取-CNVD-2020-68596.assets/1627363032539277.jpg)
...
![](Weiphp5.0-前台文件任意读取-CNVD-2020-68596.assets/1627363032949491.jpg)

定义值默认为 1，所以这里调用则可以获得数据库中Pictrue表的内容，间接的知道了文件内容以及文件名

访问地址: **http://webphp/public/index.php/home/file/user_pids**

![](Weiphp5.0-前台文件任意读取-CNVD-2020-68596.assets/1627363033210492.jpg)
...
![](Weiphp5.0-前台文件任意读取-CNVD-2020-68596.assets/1627363033633544.jpg)