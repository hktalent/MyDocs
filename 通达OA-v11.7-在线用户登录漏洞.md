...
![](通达OA-v11.7-在线用户登录漏洞.assets/16273635288620749.jpg)

简单阅读PHP源码可以知道 此SQL语句会查询用户是否在线，如在线返回此用户 Session ID

![](通达OA-v11.7-在线用户登录漏洞.assets/1627363529307947.jpg)

将返回的 Set-Cookie 中的Cookie参数值使用于登录Cookie

访问目标后台 http://xxx.xxx.xxx.xxx/general/ 

![](通达OA-v11.7-在线用户登录漏洞.assets/1627363529597397.jpg)

当目标离线时则访问漏洞页面则会出现如下图

![](通达OA-v11.7-在线用户登录漏洞.assets/1627363529807561.jpg)
...
![](通达OA-v11.7-在线用户登录漏洞.assets/1627363530201235.jpg)
...
![](通达OA-v11.7-在线用户登录漏洞.assets/16273635307908921.jpg)