...
![](rConfig-ajaxEditTemplate.php-后台远程命令执行漏洞.assets/1627363582953668.jpg)
...
![](rConfig-ajaxEditTemplate.php-后台远程命令执行漏洞.assets/1627363583266392.jpg)



这里写入文件 **test.php.yml**,并使用 **../** 跳出限制的目录，访问 test.php.yml 实际访问了 test.php，执行id命令

![](rConfig-ajaxEditTemplate.php-后台远程命令执行漏洞.assets/1627363583431381.jpg)
...
![](rConfig-ajaxEditTemplate.php-后台远程命令执行漏洞.assets/1627363583696573.jpg)