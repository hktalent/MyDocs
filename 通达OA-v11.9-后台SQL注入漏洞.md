...
![](通达OA-v11.9-后台SQL注入漏洞.assets/16273635113780632.jpg)
...
![](通达OA-v11.9-后台SQL注入漏洞.assets/1627363511756897.jpg)

其中 **updateAll()** 函数并没有使用防止 SQL注入的 **sql_injection()** 来防止注入

**webroot/inc/conn.php**

![](通达OA-v11.9-后台SQL注入漏洞.assets/1627363512096641.jpg)
...
![](通达OA-v11.9-后台SQL注入漏洞.assets/16273635124914072.jpg)

如果uid错误则不会出现时间延迟，将请求包放入 Sqlmap跑一下

![](通达OA-v11.9-后台SQL注入漏洞.assets/16273635128443258.jpg)
