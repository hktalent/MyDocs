...
![](JumpServer-未授权接口-远程命令执行漏洞.assets/16273630626564631.jpg)

**资产管理 --> 管理用户**

![](JumpServer-未授权接口-远程命令执行漏洞.assets/1627363062943187.jpg)

**用户管理 --> 用户列表**

![](JumpServer-未授权接口-远程命令执行漏洞.assets/16273630632122712.jpg)

**资产管理 --> 资产列表**

![](JumpServer-未授权接口-远程命令执行漏洞.assets/1627363063468738.jpg)

查看一下项目代码提交变动

![](JumpServer-未授权接口-远程命令执行漏洞.assets/16273630637626219.jpg)
...
![](JumpServer-未授权接口-远程命令执行漏洞.assets/1627363064156953.jpg)

比如send这里获取的 Task id ,这里是可以获得一些敏感的信息的

![](JumpServer-未授权接口-远程命令执行漏洞.assets/1627363064505344.jpg)



查看一下连接Web终端的后端api代码

![](JumpServer-未授权接口-远程命令执行漏洞.assets/16273630651934772.jpg)

可以看到这里调用时必须需要 **user asset system_user** 这三个值，再获取一个20秒的 **token**

访问web终端后查看日志的调用

![](JumpServer-未授权接口-远程命令执行漏洞.assets/16273630653873742.jpg)
...
![](JumpServer-未授权接口-远程命令执行漏洞.assets/16273630657384388.jpg)
...
![](JumpServer-未授权接口-远程命令执行漏洞.assets/1627363066138259.jpg)

发送请求获取20s的token

![](JumpServer-未授权接口-远程命令执行漏洞.assets/1627363066431946.jpg)

看一下 koko.js 这个前端文件

![](JumpServer-未授权接口-远程命令执行漏洞.assets/16273630667531798.jpg)

后端代码 https://github.com/jumpserver/koko/blob/e054394ffd13ac7c71a4ac980340749d9548f5e1/pkg/httpd/webserver.go

![](JumpServer-未授权接口-远程命令执行漏洞.assets/1627363066975311.jpg)

这里我们就可以通过 获得的token来模拟请求

![](JumpServer-未授权接口-远程命令执行漏洞.assets/16273630675515578.jpg)

成功连接模拟了这个 token 的请求,可以在Network看一下流量是怎么发送的

![](JumpServer-未授权接口-远程命令执行漏洞.assets/16273630679423091.jpg)

模拟连接发送和接发数据

![](JumpServer-未授权接口-远程命令执行漏洞.assets/1627363068277968.jpg)
...
![](JumpServer-未授权接口-远程命令执行漏洞.assets/1627363068920017.jpg)

![](JumpServer-未授权接口-远程命令执行漏洞.assets/1627363069724027.jpg)
